...
class Ganjnama extends My_Controller
{
    function Ganjnama()
    {
        parent::__construct();
    ...
    function index($index = 1)
    {
        ...
        if ($index == (int)1)
            $index = (get_cookie('ganjnama_page_no') != false ? get_cookie('ganjnama_page_no') : 1);

        $lines = $this->bhai_nand_lal_dao->get_ganjnama_lines($index);
        ...
        $this->load->view('forms/page-by-page/ganjnama', $page);
    }
    ...
    function page($index = 1, $d = 'line', $line_no = 'NA')
    {
        ...
        if($d == 'ajax'){
            echo json_encode([
                'content' => $this->load->viewPartial('forms/page-by-page/ganjnama', $page),
    ...
    function shabad($shabad_id = 0, $line = 0, $lineno = 0){
        ...
        $page['meta_keywords']    = 'Bhai Nand Lal - ganjnama shabad , bnl-shabad,';
        $page['meta_title'] = 'Bhai Nand Lal - ganjnama - SearchGurbani.com';
        $page['meta_description'] = 'Bhai Nand Lal - ganjnama - SearchGurbani.com';
        ...
        $this->load->view('forms/page-by-page/bhai-nand-lal-ganjnama-shabad', $page);
    ...
    function verse($verse_id,$d = null)
    {
        ...
        $page['base_url'] = $SG_BNL['ganjnama']['controller_name_dash'] . '/verse';
        ...
        // load the page
        $page['theme'] = 'theme_7';
        $page['meta_title'] = 'Bhai Nand Lal - Ganjnama Verse';
        ...
        if($d == 'ajax'){
            ...
            echo json_encode([
                'content' => $this->load->viewPartial('forms/page-by-page/bhai-nand-lal-ganjnama-verse', $page),
                'title' => $page['meta_title'],
                'description' => $page['meta_description'],
                'keywords' => $page['meta_keywords'],
            ]);
            ...
            $this->load->view('forms/page-by-page/bhai-nand-lal-ganjnama-verse', $page);
    ...
    function search($text = null, $pageNo = 0)
    {
        ...
        $searchcount['total'] = $this->bhai_nand_lal_dao->searchCountGanjnama($text);

        $totalRows = count($searchcount['total']);
        //echo $totalRows;exit;

        $this->load->library('pagination');
        $config = array('base_url' => site_url('bhai_nand_lal/ganjnama/search/' . $text),
            'total_rows' => $totalRows,
            'per_page' => '10'
        );
        $this->pagination->initialize($config);
    
        $page['lines'] = $this->bhai_nand_lal_dao->searchTextGanjnama($text, $config['per_page'], $pageNo);
        ...
        $this->load->view('forms/page-by-page/searchganjnama', $page);
    }
    ...
    function ajax_remember_me()
    {
        ...
        set_cookie('ganjnama_page_no', $page_no, 365 * 24 * 60 * 60);
    }
