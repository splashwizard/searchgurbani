...
class Ghazal extends My_Controller
{
    function Ghazal()
    {
        parent::__construct();
    ...
    function index()
    {
        ...
        $page_no = (get_cookie('ghazal_page_no') != false ? get_cookie('ghazal_page_no') : $SG_BNL['ghazal']['page_from']);
        $lines = $this->bhai_nand_lal_dao->get_ghazal_lines($page_no);
        ...
        if (get_last_segment() == "pdf_view") {
            ...
            $html = $this->load->view('forms/page-by-page/ghazal', $page, true);
        ...
        $this->load->view('forms/page-by-page/ghazal', $page);
    }
    ...
    function page($page_no = 1, $d = 'line', $line_no = 'NA')
    {
	    ...
	    if($d == 'ajax'){
            echo json_encode([
                'content' => $this->load->viewPartial('forms/page-by-page/ghazal', $page),
    ...
    function shabad($shabad_id = 0, $line = 0, $lineno = 0){
        ...
        $this->load->view('forms/page-by-page/bhai-nand-lal-ghazal-shabad', $page);
    ...
    function verse($verse_id,$d = null)
    {
        ...
        $page['base_url'] = $SG_BNL['ghazal']['controller_name_dash'] . '/verse';
        ...
        // load the page
        $page['theme'] = 'theme_7';
        $page['meta_title'] = 'Bhai Nand Lal - Ghazal Verse';
        ...
        if($d == 'ajax'){
            echo json_encode([
                'content' => $this->load->viewPartial('forms/page-by-page/bhai-nand-lal-ghazal-verse', $page),
                'title' => $page['meta_title'],
                'description' => $page['meta_description'],
                'keywords' => $page['meta_keywords'],
            ]);
            ...
            $this->load->view('forms/page-by-page/bhai-nand-lal-ghazal-verse', $page);
        }
    }
    ...
    function search($text = null, $pageNo = 0)
    {
        ...
        $searchcount['total'] = $this->bhai_nand_lal_dao->searchCount($text);

        $totalRows = count($searchcount['total']);


        $this->load->library('pagination');
        $config = array('base_url' => site_url('bhai_nand_lal/ghazal/search/' . $text),
            'total_rows' => $totalRows,
            'per_page' => '10'
        );
        $this->pagination->initialize($config);
        
        $page['lines'] = $this->bhai_nand_lal_dao->searchText($text, $config['per_page'], $pageNo);
        ...
        $this->load->view('forms/page-by-page/searchghazal', $page);
    }
    ...
    function ajax_remember_me()
    {
        ...
        set_cookie('ghazal_page_no', $page_no, 365 * 24 * 60 * 60);
    }
}