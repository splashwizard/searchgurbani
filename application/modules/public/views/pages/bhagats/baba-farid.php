...
<div class="page-content">
    <div class="container-fluid">
        <div class="contents">
            <h3 class="top-heading no-top">Baba Sheik Farid</h3>

<hr/>


<img src="<?php echo base_url(); ?>static/images/content/s_farid.gif" alt="Baba Farid ji" align="left" width="324"
     height="276">

<p class="black"> Farid was to Punjabi what Chaucer was to English. He made Punjabi poetry and poetry Punjabi. Later when Adi Granth
...
<p class="black">The year was 1398. Timur was returning home after ransacking Delhi -light of mind but laden with gold, trampling
...
<p class="black">Nobody replied. He shouted again. Everyone remained totally speechless. At last an old man came forward and said,
...
<p class="black">Acknowledged by every literary authority as the first major poet of the Punjabi language, Farid was to Punjabi what
    ...
    thought.</p>
<p class="black">Among the many social and religious movements in India of the last two thousand years, the Bhakti movement of the
    ...
    <img src="<?php echo base_url(); ?>static/images/content/farid.jpg" alt="" width="245" height="300" align="right">
</p>
<p class="black">One great characteristic of the Indian civilization is that more than its kings and warriors and generals, it is the
...
<p class="black">Baba Farid lived in Punjab in the 13th century and composed hymns in Punjabi, the likes of which are yet to be
...
<p class="black">Farid occupies a place of pre-eminence among the Punjabi poets. During his lifetime, wherever he went, whomever he
...
<p class="black">Farid's mother was very wise &amp; noble, and wished for her son to acquire the best education so that he could
...
<p class="black">The essence of the hymns of Farid can be stated as follows:<br>
...
<p class="black">Baba Farid ji exhorts mankind to cultivate these &amp; all such virtues. He states that Contentment resides in the
    ...
    house.</p>
<p class="black">The hymns of Sheikh Farid are available at 3 different places in the Siri Guru Granth Sahib Ji (SGGS):<br>
...
<p class="black">"The alleyway is muddy, O Farid, The Beloved&rsquo;s House is distance, if I go I would drench my cloak, And break my
    ...
    soil.</p>
<p class="black">The high reputation Farid obtained in Delhi soon became irksome to him. He therefore made his way to Hansi, where he
...
<p class="black">Sheikh Farid ji made Pak Pattan a great center of Sufi thoughts. People from all over India and Middle-east would
...
<p class="black">Once seven hundred holy men were sitting together. An inquirer put them four questions to which Baba Farid ji replied
    :<br>
...
<p class="black">Baba Farid visited a city called Mokhalpur, it is now called Faridkot in honor of the Baba Farid, and is in the
...
<p class="black">Baba Farid died of Pneumonia on the fifth day of the month of Muharram, CE 1266. The date of Baba Farid's death is
...
<p class="black">The trick works. Farid wakes up at the appointed time and making sure that his prize has been duly kept beneath the
...
<p class="black"> Owing partly to the distance of time between Sheikh Farid and Guru Nanak and partly to the influence of eastern
...
<p class="black">It is sometimes argued that since the modern Indian languages began to take shape in the eighth or ninth century and
...
<p class="black">There can be no doubt about Sheikh Farid's deep learning. His available compositions, though written in a dialect,
...
<p class="black"> However, a feature of Sheikh Farid's compositions available in the Guru Granth is that they do not seem to be the
...
<p class="black">In yet another verse, he says again:</p>
<blockquote>
...
<p class="black">This world indeed appears to Sheikh Farid to be an obstacle in the way of man's union with God. He says:</p>
<blockquote>
...
<p class="black">Life in this world is a period of separation from God, which is full of sorrow, and pain:</p>
<blockquote>
    <p class="black"><em>Sorrow is the bedstead,</em><em><br>
    ...
    <p class="black"><em>Give it not me, Oh Lord, that I should</em><em><br>
            <em>seek alien shelter.</em><br>
            <em>If that is what You have willed,</em><br>
            <em>Rather take the life out of this body.</em></em></p>
    <p class="black"><em>Man's duty in this life is to win the love of God as it is the woman's to win the love of her husband, and as
    ...
    <p class="black"><em>I did not sleep with my love tonight</em><em><br>
            <em>And every bit of my body aches.</em><br>
            <em>Go ask the deserted ones,</em><br>
            <em>How they pass their nights.</em></em></p>
    <p class="black"><em>I am not afraid of the passing of my youth,</em><em><br>
            <em>If the love of my Lord does not pass with it.</em><br>
            <em>So many youths have withered away without love. </em></em></p>
</blockquote>
<p class="black">The fear of death is perhaps a more forceful emotion in Sheikh Farid's poetry and he has expressed it in touching
...
<p class="black">The impermanence of life on this earth has been illustrated by the figure of a bir4 coming to play on the bank of a
...
<blockquote>
    <p class="black"><em>On the bank of a pool in the moor</em><em><br>
            <em>The swan has come to alight</em><br>
            <em>But he does not dip his beak to drink,</em><br>
            <em>He is eager to fly away. </em></em></p>
</blockquote>
<p class="black">The teachings of Sheikh Farid as embodied in these verses do not indeed smack at all of any superior attitude. He
...
<blockquote>
    ...
    <p class="black"><em>Says Farid, you must fathom the ocean which contains what you want </em><em><br>
