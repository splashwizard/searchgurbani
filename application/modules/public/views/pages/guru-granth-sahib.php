...
<div class="page-content">
    <div class="container-fluid">
        ...
        <p style="text-align: justify">The Guru Granth Sahib is a sacred scripture of the world and is the Eternal Guru of the Sikhs. Because it is a
            ...
            preserved in its original format since its last completion by Guru Gobind Singh in 1705.
            <img style="padding:10px 10px 10px 0; float:left;width: 40%;" src="<?php echo base_url(); ?>static/images/content/ggs_01.jpg" alt="Image Loading"/>
        </p>
        <p style="text-align: justify"> It is well known that religious institutions protect themselves from erosion by enshrining their tenets and
