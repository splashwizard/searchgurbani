...
<div class="page-content">
    <div class="container-fluid">
        <br/>
        <h3 class="no-top maroon">Musical Instruments in Gurmat Sangeet</h3>
        <hr/>
        <div class="content">
            <table width="98%" border="0" align="center" cellpadding="2" cellspacing="2">
                <tr>
                    <td>
                        ...
                        <p>Right from the Vedic times, musical instruments were used in India. Ancient sculptures and
                            temples
                            show different kinds of drums, whistles, flutes, harps, gongs, and bells. During the many
                            following
                            centuries, these rough instruments were developed and refined into the forms in which we see
                            them
                            today. Some of the instruments are now decorated with ivory, silver, gold and
                            peacock-feathers. Some
                            of the instruments have facilities for playing delicate gamaks. Musical instruments are made
                            by
                            skilled craftsmen who have knowledge of musical sounds. The important towns where these
                            instruments
                            are manufactured are Lucknow, Rampur, Madras, and Tanjore.</p>
                        <p> Nowadays, many musical instruments are used, as for example, tampura, sitar, harmonium,
                            veena,
            ...
            Vitat vad consists of those stringed instruments which are played with above, e.g., sarangi, dilruba, taoos, and asraj.</span>
                        ...
                        <p> (<strong>3) <a href="<?php echo base_url(); ?>saaj/percussion">Avanad vad (leather or
                                    percussion
                                    instruments)</a></strong><br/>
