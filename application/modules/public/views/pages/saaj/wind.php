...
<div class="page-content">
    <div class="container-fluid">
        <br/>
        <h3 class="no-top maroon">Wind Instruments</h3>
        <hr/>
        <div class="content">
            <table width="98%" border="0" align="center" cellpadding="2" cellspacing="2">
                <tr>
                    <td><p><strong class="psrednav">WIND INSTRUMENTS</strong><br/>
                            ...
                            <strong></strong><img src="<?php echo base_url(); ?>static/images/content/harmonium.jpg"
                                                  alt="harmonium"
                                                  width="165" height="91" align="left"/>The <em>harmonium </em>is
                            popular kind
                            ...
                            The <em>harmonium </em>has the appearance of a box out of which music can be produced. It is
                            a
                            reed-blown instrument like a large harmonica with mechanical bellows and keyboard. It is
                            said that
                            the <em>harmonium </em>was first produced in Paris in 1840 by Alexandre Debain. He devised a
                            bellows
                            worked by the player&rsquo;s feet to force air into a wind-chest and then through channels
                            opened or
                            ...
                            through
                            the inner reeds and produces twelve notes (seven <em>shudh, </em>four <em>komal </em>and one
                            <em>teevar). </em>The
                            <em>harmonium </em>has either single reed or double reeds. In case of double reeds, two
                            notes of the
                            same type, in two <em>saptaks </em>are produced simultaneously. Generally, a
                            <em>harmonium </em>has
                            three or three and a half <em>saptaks. </em>This instrument is very easy to handle and is
                            very
                            popular in North India. The beginner can easily play it and learn both vocal and
                            instrumental music.
                            The instrument has fixed notes and its tones cannot be changed. The <em>harmonium </em>can
                            be used
                            also an<em> </em>accompaniment of a vocalist. Any <em>svara </em>(note) can take the place
                            of S and
                            the raga played accordingly.<br/>
                            The twelve notes of the <em>harmonium </em>are not natural notes but are a tempered scale.
                            In the
                            <em>saptak, </em>the difference between S and R and again between R and G and so on has been
                            to
                            ...
                            <em>sitar</em>). With
                            the accompaniment of <em>harmonium-</em>notes, the <em>svaras </em>of vocal music also tend
                            to be
                            artificial.<br/>
                            By playing the <em>harmonium, </em>the human voice becomes artificial, because according to
                            the
                            tradition of Indian classical music, the real notes of 22 <em>shruties </em>should be
                            produced.
                            ...
                            <em>svaras</em> on the <em>harmonium </em>tends to make the <em>svaras </em>unnatural or
                            unreal.
                            Many classical singers frown at the use of <em>harmonium. </em>For Strange ways condemns the
                            use of
                            ...
                            [2]<br/>
                            It is not good to practise <em>svara-sadhana </em>(note modulation) on the
                            <em>harmonium. </em>It is
                            better to practise the <em>svaras </em>on the<em> tamboora</em>. When the strings are
                            touched, they
                            vibrate and the note continues to sound for a while, but in the case of the
                            <em>harmonium, </em>the
                            tone starts for a while, but in the case of the <em>harmonium, </em>the tone starts with
                            inflation
                            ...
                            <em>svaras </em>in a <em>raga)</em> are not possible on a <em>harmonium </em>and as such,
                            richness
                            ...
                            <strong></strong><img src="<?php echo base_url(); ?>static/images/content/flute.jpg" alt="flute"
                            ...
                            are
                            also used on special occasion. The <em>vedas </em>refer to the flute as <em>venu. </em>In
                            North
                            India it is known by different names like <em>bansari, murali; </em>in South India it is
                            called <em>pillam
                            ...
                            region to
                            another. The popular flute in South India is called <em>mukhaveena, </em>which is a
                            double-reeded
                            pipe with seven holes. The bigger f lute-type instrument is called <em>nagaswara. </em>A new
                            instrument of the wind-family is the <em>shehnai. </em>The oboe-like double reed instrument
                            is
                            supposed to be auspicious and is played to celebrate a marriage or festival.
                            <em>Shehnai </em>concerts
                            have become popular these days. Bismillah Khan and his group of <em>shehnai-</em>players
                            have own
