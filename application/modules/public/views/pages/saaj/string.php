<div class="page-content">
    <div class="container-fluid">
        <br/>
        <h3 class="no-top maroon">Stringed Instruments</h3>
        <hr/>
        <div class="content">
                ...
                <tr>
                    <td><p>&nbsp;</p>
                        <p><strong class="psrednav">STRINGED INSTRUMENTS </strong><br/>
                            ...
                            <strong></strong><img src="<?php echo base_url(); ?>static/images/content/tanpura.jpg"
                                                  alt="tanpura"
                                                  width="55" height="150" align="right"/>This is one of the oldest and
                            popular
                            ...
                            There are four strings in the <em>tanpura. </em>The first to the left is of steel. Sometimes
                            in a
                            <em>tanpura </em>is used for accompanying a male voice, the first string is of brass or
                            bronze. This
                            string is called <em>oancham </em>because it gives out the note of P. This is tuned to the P
                            of the
                            <em>madhya saptak </em>when accompanied by a harmonium. In the <em>raga</em> in which P is
                            forbidden
                            (as for instance in <em>Malkaus raga), </em>this string is tuned to M <em>shudh. </em>In the
                            first
                            place, the two middle strings of steel should be tuned to S of the male singer. The fourth
                            string is
                            of brass or bronze. It is tuned to S of the <em>mandar saptak. </em>(In the case of a female
                            voice
                            the S is set to fourth of fifth black reed of the <em>harmonium). </em>Some<em>
                                tanpuras</em>have
                            ...
                            <strong></strong><em>S<img src="<?php echo base_url(); ?>static/images/content/sitar.jpg"
                                                       alt="sitar"
                                                       width="90" height="150" align="left"/>itar </em>literally is a
                            form of
                            the Persian word-<em>sihtar-</em>which means three strings. In the beginning, there were
                            only three
                            strings, but now seven strings are used.<br/>
                            The components of a <em>sitar </em>are similar to those of the <em>tanpura. </em>It has a
                            <em>toomba,
                            ...
                            The <em>sitar</em>has seven strings. The first string on the left is made of steel. It is
                            called
                            <em>Baj-ki-tar. </em>It is tuned to M of <em>mandar saptak. </em>This is the string which is
                            more
                            frequently used in playing the <em>sitar.</em><br/>
                            <em></em>The second string is made of bronze and is called <em>jori-ka-tar. </em>The string
                            is tuned
                            to S of <em>mandar saptak. </em>The third string is made of bronze. This is also
                            <em>jori-ka-tar. </em>The string is also tuned to S of <em>mandar saptak </em>like the
                            second
                            string. These two strings are tuned in the very beginning like the <em>tanpura. </em>The
                            fourth
                            string is made of steel. This is tuned to P of <em>mandar saptak. </em>The sixth string is
                            made of
                            thin steel and it s called <em>chikari. </em>It is tuned to S of <em>mandar saptak. </em>The
                            seventh
                            string is also made of thin steel and is also called <em>chikare. </em>It is tuned to S of
                            <em>Tar
                                saptak. </em>Some people tune the seventh string to the <em>pancham </em>(P) of <em>madhya
                                saptak.</em><br/>
                            <br/>
                            <strong>3. Mikrab</strong><br/>
                            <strong></strong>This is the plectrum made of steel or brass which is worn on the right hand
                            index
                            ...
                            that of
                            R. Some sitars have ab extra <em>toomba </em>(gourd) at the end of the neck or midway. The
                            sitar is
                            ...
                            <em></em>(c)<em> Jhala: </em>Playing on the <em>chikari </em>strings in quick tempo which
                            like D R R
                            R - is called <em>jhala. </em>The first string gives the note of D, and the final <em>chikari </em>give
                            the tone of R.<br/>
                            (d) <em>Asthai and Antra: Asthai </em>is fixed composition of the raga. The <em>antra </em>is
                            the
                            compliment to the<em> asthai. </em>In the improvisation of the raga, after <em>asthai</em>
                            and<em>
                                antra, meend </em>(gliding) <em>and jamjam/murki </em>(trill) are played frequently.
                            <em>Tans </em>are also played.<br/>
                            Nowadays <em>sitarists </em>generally play in <em>khayal </em>style. Sometimes
                            <em>thumri </em>style
                            is also used. Like <em>khayal </em>singers, instrumentalists will play in <em>drut
                                laya </em>(fast
                            tempo). They will play a new <em>asthai </em>and <em>antra, </em>generally in
                            <em>teental </em>and
                            ...
                            <img src="<?php echo base_url(); ?>static/images/content/veena.gif" alt="veena" width="45"
                                 height="150"
                                 align="right"/>Perhaps the oldest stringed instrument belonging to the seventh century
                            is
                            ...
                            categories: north Indian and south Indian. The north Indian <em>veena is </em>called <em>vachitra
                                veena </em>and has no frets. The south Indian <em>veena </em>is more complicated and is
                            called
                            <em>saraswati veena. </em>As the name implies, this instrument is supposed to be the
                            favourite of
                            Saraswati, the goddess of learning. Some of the <em>veenas </em>have the painting of the
                            goddess on
                            the body. There are also other types of <em>veenas </em>with motifs of peacocks or
                            crocodiles or
                            some animal. The <em>veena </em>has seven strings of brass. Four strings are tuned to S, P,
                            S, P and
                            ...
                            with
                            fingers or with a plectrum. There is also a superior kind of <em>veena </em>carved out of
                            one piece
                            of wood. The <em>veena </em>is played in a horizontal position as it rests on the lap of the
                            player.<br/>
                            <br/>
                            <strong>5. Sarangi</strong><br/>
                            <strong></strong><img src="<?php echo base_url(); ?>static/images/content/sarangi.jpg"
                                                  alt="sarangi"
                                                  width="90" height="150" align="left"/>The <em>sarangi</em> is a
                            popular
                            stringed instrument of North India. It has been in use from the thirteenth century. It can
                            be played
                            either solo or as an accompaniment of <em>khayal or thumri </em>or folk-song. The body is of
                            teak
                            ...
                            <em>mandar
                                saptak. </em>In some cases, first string may be of metal. Some <em>sarangis </em>also
                            have few
                        ...
                        <p><strong>6. Rabab</strong><br/>
                            ...
                            accompaniment for <em>Gurumat Sangeet </em>(Sikh sacred music). It was played by his
                            disciple named
                            Bhai Mardana (1459-1519) who originally was a<em> mirasi </em>(Muslim musician). It is
                            similar to
                            the rebec of Persia. The <em>rabab</em> has a piece of hollow wood at the top and a hollow
                            circular
                            ...
                            pegs at
                            the top. Some <em>rababs </em>have a wooden <em>toomba </em>(gourd) at the top. It is played
                            with a
                            ...
                            <strong></strong>This instrument closely resembles the <em>sarangi</em>. It is about two
                            feet long,
                            ...
                            Gurus and
                            their bards. It is played with a bow. Sometimes small bells (<em>gungroos) </em>are attached
                            to the
