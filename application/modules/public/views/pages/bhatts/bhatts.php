...
<div class="page-content">
    <div class="container-fluid">
        <div class="contents">
            <h3 class="top-heading no-top">Bhatt &amp; Bards </h3>
            <hr/>
            <p class="">
                <strong>Bhatts &amp; Bards in Sri Guru Granth Sahib ji</strong>
            </p>
            <div class="row links">
                <div class="col-md-3 col-sm-3 col-xs-3">
                    <ul class="list-group">
                        <li><a href="<?php echo base_url(); ?>bhatts/bhatt-kalshar"> Kalshar</a></li>
                        <li><a href="<?php echo base_url(); ?>bhatts/bhatt-salh">Salh</a></li>
                        <li><a href="<?php echo base_url(); ?>bhatts/bhatt-mathura">Mathura</a></li>
                        <li><a href="<?php echo base_url(); ?>bhatts/satta">Satta and Balwand</a></li>
                    </ul>
                </div>
                <div class="col-md-3 col-sm-3 col-xs-3">
                    <ul class="list-group">
                        <li><a href="<?php echo base_url(); ?>bhatts/bhatt-jalap">Jalap</a></li>
                        <li><a href="<?php echo base_url(); ?>bhatts/bhatt-bhalh">Bhalh</a></li>
                        <li><a href="<?php echo base_url(); ?>bhatts/bhatt-balh">Bal</a></li>
                        <li><a href="<?php echo base_url(); ?>bhatts/mardana">Bhai Mardana Ji</a></li>
                    </ul>
                </div>
                <div class="col-md-3 col-sm-3 col-xs-3">
                    <ul class="list-group">
                        <li><a href="<?php echo base_url(); ?>bhatts/bhatt-kirat">Kirat</a></li>
                        <li><a href="<?php echo base_url(); ?>bhatts/bhatt-nalh">Nal</a></li>
                        <li><a href="<?php echo base_url(); ?>bhatts/bhatt-haribans">Harbans</a></li>
                        <li></li>
                    </ul>
                </div>
                <div class="col-md-3 col-sm-3 col-xs-3">
                    <ul class="list-group">
                        <li><a href="<?php echo base_url(); ?>bhatts/bhatt-bhika">Bhika</a></li>
                        <li><a href="<?php echo base_url(); ?>bhatts/bhatt-gyand">Gyand</a></li>
                            <li><a href="<?php echo base_url(); ?>bhatts/sunderbaba">Baba Sunder ji</a></li>
                        <li></li>
                    </ul>
                </div>
            </div>
            <p class="black"> Bhatt Bani (the hymns by the bards) comprising twenty pages is incorporated
            ...
            <p class="black"> During the medieval times Bhatts were more popularly known as the
            ...
            <p class="black"> According to the chronicler Sant Singh Bhatt
            ...
            <p class="black"> A significant point to be noted in this respect is that these Bhatts
            ...
            <p class="black"> Bhai Kahan Singh Nabha, author of Mahan Kosh has referred to an en
            ...
            <p class="black"> According to records it is stated that Bhatt Bani was incorporated Adi
            ...
            <p class="black">BANI, recorded under the title Savaiyye, is the
            ...
            <p class="black">&nbsp;Bhãi Gurdãs also gives in his Vãrãñ, XI. 21, a brief account
            ...
            <p class="black"> The main purpose of these savaiye is to &nbsp;acclaim the Gurus, not as
