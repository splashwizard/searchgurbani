            ...
            <tr>
                <td width="100%" valign="top" bgcolor="#ffffff" align="left">
                            ...
                            <td>
                                <form action="megasrch.php?Param=hindi" id="form" name="form" method="post">
                                    ...
                                    if ($sess_search_parameters['individual_search'] != 1) {
                                        ...
                                        $this->load->viewPartial('forms/search-results-scripture-combo', array('this_page' => 'ggs'));
                                    }
                                    ?>
                    ...
                    <table width="100%" cellspacing="0" cellpadding="2" border="0">
                        ...
                        <tr>
                            <td width="100%" nowrap="nowrap" bgcolor="#fceaaa" align="left" class="subhead">&nbsp;<strong><?php
                    ...
                    <br>
                    <p class="pagination_links"><?php echo $pagination_links; ?>&nbsp;<p class="pagination_links"></td>
            </tr>
            <tr>
                <td></td>
            </tr>
