...
if ($this->session->userdata('book_lang') == '' or $this->session->userdata('book_lang') == 'gurmukhi') {
    $lang_button = '<a href="' . site_url('sri-guru-granth-darpan/page/' . $page_no . '/hindi') . '" class="btn btn-next">View in Hindi</a>';
    $display_lang_field = 'text';
} else {
    $lang_button = '<a href="' . site_url('sri-guru-granth-darpan/page/' . $page_no . '/gurmukhi') . '" class="btn btn-next">View in Gurmukhi</a>';
...
<div class="row">
	...
	<div class="col-md-8 col-sm-8 text-right">
		<div class="ang-paginate">
			' . $lang_button . '
			<a href="' . site_url('sri-guru-granth-darpan/') . '" class="btn btn-next">Search Page</a>  ';
...
$utilityBar
    ...
    <div class="utility-bar1 text-right">
			' . anchor_popup('sri-guru-granth-darpan/page/' . $page_no . '/print-view', '<i class="fa fa-print" title="Print this page"></i>', $atts) . '&nbsp;
    </div>
';
