        ...
        if ($SG_Preferences['text_type'] == 'line_by_line') {
            ...
            foreach ($lines->result() as $line) {
			  ...
			  <br>' . $line->raag . ' ' . $line->author . '</p><br>';
                ...
                $share_data['whatsapp_sharelink'] = site_url('public/amrit-keertan/shabad/' . $line->shabad_id . '/' . $url_shabad_name);
                $sharing_data .= $this->load->viewPartial('templates/share-this', $share_data, true);
                $sharing_data .= '</span>';
