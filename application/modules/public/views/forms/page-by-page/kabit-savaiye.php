   ...
   <div class="row">
		<div class="col-md-6 col-sm-6">
			...
			<form name="goto_page" id="goto_page" action="" method="post" onsubmit="return gotoPage(this);">
				Goto Kabit <input type="text" name="page_no" id="page_no" class="form-control" style="width: 15%" " maxlength="5" value="' . $current_page . '" />
	...
	<div class="row">
            ...
            <div class="col-md-4 col-xs-4 center">
                <div class="ang-count bold">Displaying Kabit ' . $current_page . ' <span> of ' . $SG_ScriptureTypes[$scripture]['page_to'] . '</span></div>
            </div>
            <div class="col-md-4 col-xs-4"></div>
    </div>
</div>';
...
$utilityBar = '
        <div class="utility-bar1 text-right">
             <div class="utility_buttons">
                ' . anchor_popup(site_url($SG_ScriptureTypes[$scripture]['controller_name_dash'] . '/kabit/' . $current_page .'/print-view'), '<i class="fa fa-print" title="Print this page"></i>', $atts) . '
...
if ($lines === false) {
    ...
    if ($SG_Preferences['text_type'] == 'line_by_line') {
        ...
        foreach ($lines->result() as $line) {
            ...
            $attributes = ($line->k_line != "" ? '<p class="line_info"> ' . $line->lattrib . '</p>' : '');
            ...
            $share_data['whatsapp_sharelink'] = site_url('kabit-savaiye/kabit/' . $current_page . '/line/' . $line->lineno);
