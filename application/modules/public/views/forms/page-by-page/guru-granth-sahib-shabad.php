...
//                    $attributes = '<p class="line_info">' . $line->raag . ' ' . $line->author . '</p>';
                    ...
                    $attributes = '<p class="line_info"> ' . $line->pattrib . ' <br> ' . $line->raag . ' ' . $line->author . '
                      </p>
                      ';

                    $sharing_data = '<span class="share_icons"><a class="btn btn-default ang_view" href="' . site_url('guru-granth-sahib/ang/' . $line->pageno . '/line/' . $line->lineno) . '"> Ang View</a>';
