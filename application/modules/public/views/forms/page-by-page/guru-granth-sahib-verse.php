...
$utilityBar = '
        <div class="utility-bar1 text-right">
			...
			' . anchor_popup(base_url('guru-granth-sahib/verse/'.$current_page) . '/print-view', '<i class="fa fa-print" title="Print this page"></i>', $atts) . '
		    </div>
        </div>
';
    ...
    <div class="container-fluid">
        ...
        if ($data === false) {
            ...
            foreach ($data as $data) {
                ...
                $sharing_data .= '<a class="btn btn-default ang_view" href="' . site_url('guru-granth-sahib/ang/' . $data['pageID'] . '/line/' . $data['lineID']) . '"> Ang View</a>';
                
                $sharing_data .= '<a class="btn btn-default shabad_view" href="' . site_url('guru-granth-sahib/shabad/' . $data['shabdID'] . '/line/' . $data['shabdlineID']) . '"> Shabad View</a>';
                ...
                $share_data['link'] = site_url('shared/guru-granth-sahib/verse/' . $data['verseID']);
                $share_data['whatsapp_sharelink'] = site_url('guru-granth-sahib/verse/' . $data['verseID']);
