		...
		<div class="col-md-4 col-sm-4">
			<div class="ang-search ang-paginate">
                <form name="goto_page" id="goto_page" action="" method="post" onsubmit="return gotoPage(this);">
                    Goto Page <input type="text" name="page_no" id="page_no" class="form-control" style="width: 25%" size="5" maxlength="5" value="' . $current_page . '" />
    ...
    if ($SG_Preferences['text_type'] == 'line_by_line') {
        ...
        foreach ($lines->result() as $line) {
            ...
            $attributes = '<p class="line_info">' . $line->lattrib . ' <br> 
			   ...
			   <br>' . $line->raag . ' ' . $line->author . '
			   </p>';

            $sharing_data = '<span class="share_icons"><a class="btn btn-default shabad_view" href="' . site_url('amrit-keertan/shabad/' . $line->shabad_id . '/' . url_title($line->shabad_name, '-', TRUE) . '/line/' . $line->pagelineno) . '"> Shabad View</a>';
