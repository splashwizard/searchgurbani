		...
		<div class="col-md-6 col-sm-6">
			<div class="ang-search ang-paginate">
                <form name="goto_page" id="goto_page" action="" method="post" onsubmit="return gotoPage(this);">
                    Goto Page <input type="text" name="page_no" id="page_no" class="form-control" style="width: 15%" maxlength="5" value="' . $current_page . '" />
...
$navigationBar .= '
	...
	<div class="row">
            ...
            <div class="col-md-4 col-xs-4 center">
                <div class="ang-count bold">Displaying Page ' . $current_page . ' <span> of ' . $SG_ScriptureTypes[$scripture]['page_to'] . '</span></div>
            </div>
            <div class="col-md-4 col-xs-4"></div>
        </div>
</div>';
...
$utilityBar = '
        ...
        <div class="utility-bar1 text-right">
             <div class="utility_buttons">
                ' . anchor_popup(site_url($SG_ScriptureTypes[$scripture]['controller_name_dash'] . '/page/' . $current_page . '/print-view'), '<i class="fa fa-print" title="Print this page"></i>', $atts) . '
...
echo "<h2 class='no-top'>" . $SG_ScriptureTypes[$scripture][1] . "</h2>";
echo $utilityBar;
echo $navigationBar;
...
if ($lines === false) {
    ...
    if ($SG_Preferences['text_type'] == 'line_by_line') {
        ...
        foreach ($lines->result() as $line) {
            ...
            $sharing_data = '<span class="share_icons"><a class="btn btn-default shabad_view" href="' . site_url('dasam-granth/shabad/' . $line->shabdID . '/line/' . $line->shabdlineID) . '">Shabbad View</a>';
            ...
            $share_data['whatsapp_sharelink'] = site_url('dasam-granth/page/' . $current_page . '/line/' . $line->pagelineno);
