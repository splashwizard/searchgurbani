...
$utilityBar = '
        <div class="utility-bar1 text-right">
			...
			' . anchor_popup(base_url('bhai-nand-lal/jot-bikas-persian/verse/'.$current_page) . '/print-view', '<i class="fa fa-print" title="Print this page"></i>', $atts) . '
		    </div>
        </div>
';
    ...
    <div class="container-fluid">
        ...
        if ($data === false) {
            ...
            foreach ($data as $data) {
                ...
                $sharing_data .= '<a class="btn btn-default ang_view" href="' . site_url('bhai-nand-lal/jot-bikas-persian/page/' . ($data['pageID'] - 143) . '/line/' . $data['pagelineID']) . '">Page View</a>';
                
                $sharing_data .= '<a class="btn btn-default shabad_view" href="'.site_url('bhai-nand-lal/jot-bikas-persian/shabad/' . $data['shabadID'] . '/line/' . $data['shabadlineID']) . '">Shabad View</a>';
                ...
                $share_data['link'] = site_url('shared/bhai-nand-lal/jot-bikas-persian/verse/' . $data['verseID']);
                $share_data['whatsapp_sharelink'] = site_url('bhai-nand-lal/jot-bikas-persian/verse/' . $data['verseID']);
