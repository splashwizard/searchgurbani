        ...
        if ($lines === false) {
            ...
            if ($SG_Preferences['text_type'] == 'line_by_line') {
                ...
                foreach ($lines->result() as $line) {
                    ...
                    $sharing_data = '<span class="share_icons"><a class="btn btn-default ang_view" href="' . site_url('bhai-nand-lal/tankahnama/page/' . ($line->pageID - 166) . '/line/' . $line->pagelineID) . '">Page View</a>';
                    ...
                    $share_data['link'] = site_url('public/shared/bhai-nand-lal-shabad/tankahnama/shabad/' . $line->shabadID . '/line/' . $line->shabadlineID);
                    $share_data['whatsapp_sharelink'] = site_url('public/bhai-nand-lal-shabad/tankahnama/shabad/' . $line->shabadID . '/line/' . $line->shabadlineID);
