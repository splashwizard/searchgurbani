   ...
   <div class="row">
		...
		<div class="col-md-6 col-sm-6 text-right">
            <div class="ang-paginate">
                <a href="' . site_url('compilation/page/1') . '" class="btn btn-next">Book Index</a> ';

                if ($page_no > 1) {
                    $navigationBar .= '<a href="' . site_url('compilation/page/1') . '" class="btn btn-next">Begin</a> ';
                    if ($page_no + 1 > 1) {
                        $navigationBar .= '<a href="' . site_url('compilation/page/' . ($page_no - 1)) . '" class="btn btn-next">Back</a> ';
                    }
                }

                if ($page_no < $lines_count) {
                    $navigationBar .= '<a href="' . site_url('compilation/page/' . ($page_no + 1)) . '" class="btn btn-next">Next</a> ';
                    if ($page_no - 1 < $lines_count) {
                        $navigationBar .= '<a href="' . site_url('compilation/page/' . $lines_count) . '" class="btn btn-next">Last</a> ';
                    }
                }
$navigationBar .= '
          </div> 
...
<div class="page-content">
    <div class="container-fluid">
        <div class="contents">
            <h3 class="top-heading no-top">Compilation of Sri Guru Granth Sahib</h3>
...
<script type="text/javascript">
    function gotoPagee(formobj) {
        ...
        document.location.href = '<?php echo site_url('compilation/page'); ?>/' + page_no;
        return false;
    }
