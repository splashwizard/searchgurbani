        ...
        if ($lines === false) {
            ...
            if ($SG_Preferences['text_type'] == 'line_by_line') {
                ...
                foreach ($lines->result() as $line) {
                    ...
                    $sharing_data = '<span class="share_icons"><a class="btn btn-default ang_view" href="' . site_url('bhai-nand-lal/quatrains/page/' . ($line->pageID - 63) . '/line/' . $line->pagelineID) . '">Page View</a>';
                    ...
                    $share_data['link'] = site_url('shared/bhai-nand-lal-shabad/quatrains/shabad/' . $line->shabadID . '/line/' . $line->shabadlineID);
                    $share_data['whatsapp_sharelink'] = site_url('bhai-nand-lal-shabad/quatrains/shabad/' . $line->shabadID . '/line/' . $line->shabadlineID);
