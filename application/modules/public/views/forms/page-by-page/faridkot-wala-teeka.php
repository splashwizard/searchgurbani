...
if ($this->session->userdata('book_lang') == '' or $this->session->userdata('book_lang') == 'gurmukhi') {
    $lang_button = '<a href="' . site_url('faridkot-wala-teeka/page/' . $page_no . '/hindi') . '" class="btn btn-next">View in Hindi</a>';
    $display_lang_field = 'text';
} else {
    $lang_button = '<a href="' . site_url('faridkot-wala-teeka/page/' . $page_no . '/gurmukhi') . '" class="btn btn-next">View in Gurmukhi</a>';
...
<div class="utility-bar2">
    <div class="row">
		...
		<div class="ang-paginate">
                ' . $lang_button . '
                <a href="' . site_url('faridkot-wala-teeka/') . '" class="btn btn-next">Search Page</a>
                <a href="' . site_url('faridkot-wala-teeka/chapters/' . $volume_id) . '" class="btn btn-next">Chapter Index</a> ';
...
$utilityBar
    ...
    <div class="utility-bar1 text-right">
			' . anchor_popup('faridkot-wala-teeka/page/' . $page_no . '/print-view', '<i class="fa fa-print" title="Print this page"></i>', $atts) . '&nbsp;
    </div>
';
?>
<div id="page_body">
    <div class="page-content">
        <div class="container-fluid">
            <div class="contents">
                <h3 class="top-heading no-top">
                    Faridkot Wala Teeka</h3>
