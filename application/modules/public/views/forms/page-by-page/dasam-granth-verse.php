...
$utilityBar = '
        <div class="utility-bar1 text-right">
			...
			' . anchor_popup(base_url('dasam-granth/verse/' . $current_page) . '/print-view', '<i class="fa fa-print" title="Print this page"></i>', $atts) . '
		    </div>
        </div>
';
        ...
        <div class="container-fluid">
            ...
            ';
                ...
                foreach ($data as $data) {
                    ...
                    $sharing_data .= '<a class="btn btn-default ang_view" href="' . site_url('dasam-granth/page/' . $data['pageID'] . '/line/' . $data['pagelineID']) . '">Page view</a>';
                    
                    $sharing_data .= '<a class="btn btn-default shabad_view" href="' . site_url('dasam-granth/shabad/' . $data['shabdID'] . '/line/' . $data['shabdlineID']) . '">Shabbad View</a>';
                    ...
                    $share_data['link'] = site_url('shared/dasam-granth/verse/' . $data['verseID']);
                    $share_data['whatsapp_sharelink'] = site_url('dasam-granth/verse/' . $data['verseID']);
