    ...
    <div class="container-fluid">
                ...
                <td width="100%" valign="top" bgcolor="#ffffff" align="left">
                    <table cellspacing="10" cellpadding="5" border="0">
                            ...
                            <td>
                                <form action="megasrch.php?Param=hindi" id="form" name="form" method="post">
                                    ...
                                    if ($sess_search_parameters['individual_search'] != 1) {
                                        ...
                                        $this->load->viewPartial('forms/search-results-scripture-combo', array('this_page' => 'dg'));
                                    }
                                    ?>
                        ...
                        Find Results : ' . $sess_search_parameters['search_text'] . ' (' . $SG_SearchTypes[$sess_search_parameters['search_type']] . ')&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Language : ' . $sess_search_parameters['search_language'];
                                    ...
                                    if ($sess_search_parameters['individual_search'] == 1) {
                                        echo ' <input type="button" value="Goto Advanced Search" class="button" onclick="document.location.href=\'' . site_url('dasam-granth/search') . '\'">';
                                    } else {
                    ...
                    <table width="100%" cellspacing="0" cellpadding="2" border="0">
                        <tbody>
                        <tr>
                            <td width="100%" nowrap="nowrap" bgcolor="#fceaaa" align="center" class="pageheadergreen"> Sri Dasam
                                Granth Sahib
                            </td>
                        </tr>
                        <tr>
        ...
        if ($search_results === false) {
            ...
            foreach ($search_results->result() as $line) {
                ...
                $attributes = '<a href="' . site_url('public/dasam-granth/page/' . $line->pageno . '/line/' . $line->pagelineno) . '">
                        Page ' . $line->pageno . ' Line ' . $line->pagelineno . '
                    </a><br/>'.'<a  href="' . site_url('dasam-granth/shabad/' . $line->shabdID . '/line/' . $line->shabdlineID) . '">    or Go to Shabad</a>';;
