    ...
    <div class="container-fluid">
        ...
        <div class="browse-letters center">
            <span class="bold xx-text"><a
                        ...
                        href="<?php echo site_url('sggs-kosh/do-search'); ?>/ੜ/alpha">&#2652;</a>
            </span>
        </div>
        <p class="bold center small-bottom">Browse by letter</p>

                <?php
                echo "<p class='bold'>Here are the results for the letter " . $keyword . " from SGGS Kosh</p>";
                if ($lines != false) {
                    echo "
                <p class='bold'>
                    ...
                    <span class='pull-right'>
                        <a href='" . site_url('sggs-kosh') . "' class='btn btn-search-page'>Search Page</a>
                    </span>
                </p>
                ";
                }
