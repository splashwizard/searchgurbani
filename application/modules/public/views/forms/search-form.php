...
<div class="search_panel">
    <div class="container-fluid">
        <h3 class="top-heading bold no-top">Gurbani Search</h3>
                ...
                <div class="col-md-4 col-sm-4">
                    ...
                    <div class="input-group">
                        <input type="text" value="<?php echo $sess_search_parameters['search_text']; ?>"
                               name="SearchData" id="SearchData" class="search-input form-control" autocomplete="off">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="options-row">
                        <label><input name="ggs" type="checkbox" id="ggs" value="1" checked="checked"/> Sri Guru Granth
                            Sahib</label>
                        <label><input name="ak" type="checkbox" id="ak" value="1" checked="checked"/> Amrit
                            Keertan</label>
                        <label><input name="bgv" type="checkbox" id="bgv" value="1" checked="checked"/> Bhai Gurdas
                            Vaaran</label>
                        <label><input name="dg" type="checkbox" id="dg" value="1" checked="checked"/> Sri Dasam Granth
                            Sahib</label>
                        <label><input name="ks" type="checkbox" id="ks" value="1" checked="checked"/> Kabit
                            Savaiye</label>
