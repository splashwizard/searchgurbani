            ...
            <div class="col-md-12">
                <div class="contents">
                    <div class="options no-top top-heading center" align="">
                        <h3 class="bold small-bottom no-top">Sri Gur Pratap Suraj Granth - <?php echo($volume_id != 0 ? 'Section ' . $volume_id : ''); ?> Chapter Index</h3>
                    </div>
                    ...
                    <div class="chapter_index">
                        ...
                        if ($chapters != false) {
                            foreach ($chapters->result() as $chapter) {
                                ...
                                echo '
                            <a href="' . site_url('sri-gur-pratap-suraj-granth/page/' . $chapter->page_id . '/volume/' . $volume_id) . '">
