...
<div id="amrit_keetrtan" align="center"><span class="alpha"><a
            ...
            href="<?php echo site_url('sggs-kosh/do-search'); ?>/%E0%A9%99/alpha">&#2649;</a>&nbsp;</span> <br/><strong>Browse
        by letter</strong></div>
    ...
    foreach ($lines->result() as $line) {
        echo "
			<div class='line row$i'>
				<div class='word'><span class='lang_1'><a href='javascript:view_sggs_results(\"" . $line->word . "\")'>" . $line->word . "</a></span> - <span class='lang_2'>" . $line->roman . "</span> <span class='lang_3'>" . $line->hindi . "</span></div>
				<div class='description'>" . $line->description . "</div>
				<div class='description lang_2'>" . $line->roman_desc . "</div>
			</div>";
        $i = -$i;
    }
} else {
