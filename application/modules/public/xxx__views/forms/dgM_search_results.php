...
<div id="wrapper">
    <div class="content">
        <h1>Sri Dasam Granth Sahib <span class="right"><a href="<?= base_url() ?>scriptures/"
                                                          style="margin-right:10px;">Home</a><a
                ...
                <tr>
                    <td width="100%" valign="top" bgcolor="#ffffff" align="left">
					  ...
					  if($sess_search_parameters['individual_search'] != 1)
					  {
						...
						$this->load->view('forms/search_results_scripture_combo',array('this_page'=>'dg')); 
					  }
					  ?>
					  <br>
					  <?php 
                        ...
                        <table width="100%" cellspacing="0" cellpadding="2" border="0">
                            ...
                            <tr>
                                <td width="100%" nowrap="nowrap" bgcolor="#fceaaa" align="center"
                                    class="pageheadergreen"> Sri Dasam Granth Sahib
                                </td>
                            </tr>
                            <tr>
		...
		';
                ...
                foreach ($search_results->result() as $line) {
                    ...
                    $attributes = '<a href="' . site_url('scriptures/ds_page/' . $line->pageno . '/line/' . $line->pagelineno) . '">
