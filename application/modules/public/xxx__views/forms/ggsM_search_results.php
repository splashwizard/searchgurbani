...
<div id="wrapper">
    <div class="content">
        <h1>Sri Guru Granth Sahib<span class="right"><a href="<?= base_url() ?>scriptures/" style="margin-right:10px;">Home</a><a
	...
	';
                ...
                foreach ($search_results->result() as $line) {
                    ...
                    $attributes = '<a href="' . site_url('scriptures/ang/' . $line->pageno . '/line/' . $line->lineno) . '">Ang ' . $line->pageno . ' Line ' . $line->pagelineno . ' ' . $line->raag . ': ' . $line->author . '</a><br />' .

                        '<a  href="' . site_url('scriptures/ggs_shabad/' . $line->shabad_id . '/line/' . $line->shabadlineno) . '">Shabad ' . $line->shabad_id . ' Line ' . $line->shabadlineno . ' ' . $line->raag . ': ' . $line->author . '</a>';
