...
<div style="background-color:#fceaaa" align="center">
    <h2><strong>Maansarovar - Words</strong></h2>
</div>
...
<br/>
<div class="maan_words_index">
    <div>
        <span class="col_float_left"><p>Words found for '<?php echo $keyword; ?>'</p> </span>
        <span class="col_float_right"><a href="<?php echo site_url('maansarovar'); ?>"
                                         class="button">Search Page</a></span>
        <br class="clearer"/>
    </div>
    <div class="maan_words">
        <?php
        ...
        if ($words != false) {
            foreach ($words->result() as $row) {
                echo '<a href="' . site_url('maansarovar/quotations/' . $row->word) . '" class="word">' . $row->word . '</a>';
