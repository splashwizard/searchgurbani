...
<div style="background-color:#fceaaa" align="center">
    <h2><strong>Sri Guru Granth Darpan - <?php echo($volume_id != 0 ? 'Section ' . $volume_id : ''); ?> Chapter
            Index</strong></h2>
</div>
...
<div class="chapter_index">
    ...
    if ($chapters != false) {
        foreach ($chapters->result() as $chapter) {
            ...
            echo '
		<a href="' . site_url('sri-guru-granth-darpan/page/' . $chapter->page_id . '/volume/' . $volume_id) . '">
