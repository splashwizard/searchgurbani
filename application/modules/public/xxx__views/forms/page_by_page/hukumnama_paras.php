...
<div class="utility_bar">
	...
	<span class="col_float_right">
		<div class="utility_buttons">
			' . anchor_popup(site_url('hukumnama/ang/' . $pageno . '/pageno/print_view'), '<img src="' . base_url() . 'images/icons/print.gif" border="0" title="Print this page" />', $atts) . '&nbsp;&nbsp;&nbsp;
...
if ($lines === false) {
    ...
    echo '<p><strong>In Gurmukhi</strong></p>';
    echo '<div class="line row1" align="center"><p class="lang_1">';
    echo $data['punjabi'];
    echo '</p></div>';

    echo '<p><strong>Phonetic English</strong></p>';
    echo '<div class="line row-1" align="center"><p class="lang_2">';
    echo $data['translit'];
    echo '</p></div>';
    ...
    echo '<div class="line row-1"><p class="lang_3">';
    echo $data['ss_para'];
    echo '</p></div>';
}
