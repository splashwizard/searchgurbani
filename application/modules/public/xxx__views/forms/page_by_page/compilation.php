...
<div class="utility_bar">
	...
	<span class="col_33_percent align_right col_float_right"> 
		<span class="navigation_links">
			<a href="' . site_url('compilation/page/1') . '" class="button">Book Index</a> ';

if ($page_no > 1) {
    $navigationBar .= '<a href="' . site_url('compilation/page/1') . '" class="button">Begin</a> ';
    if ($page_no + 1 > 1) {
        $navigationBar .= '<a href="' . site_url('compilation/page/' . ($page_no - 1)) . '" class="button">Back</a> ';
    }
}

if ($page_no < $lines_count) {
    $navigationBar .= '<a href="' . site_url('compilation/page/' . ($page_no + 1)) . '" class="button">Next</a> ';
    if ($page_no - 1 < $lines_count) {
        $navigationBar .= '<a href="' . site_url('compilation/page/' . $lines_count) . '" class="button">Last</a> ';
    }
}
$navigationBar .= '
...
<h2>Compilation of Sri Guru Granth Sahib</h2>
