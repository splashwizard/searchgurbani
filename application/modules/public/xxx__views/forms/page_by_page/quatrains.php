...
<div class="utility_bar">
	...
	<span class="col_33_percent align_center">
		<div class="subhead">
			Displaying Rubaayee ' . $current_page . ' of ' . $SG_BNL[$scripture]['page_to'] . '
		</div>
	</span>
...
echo "<h2>Bhai Nand Lal - Rubaayee</h2>";
echo $utilityBar . "<br />";
echo $navigationBar;
...
if ($lines === false) {
    ...
    if ($SG_Preferences['text_type'] == 'line_by_line') {
        ...
        foreach ($lines->result() as $line) {
            ...
            $share_data['link'] = site_url('public/shared/bhai_nand_lal/quatrains/page/' . $current_page . '/line/' . $line->lineno);
