...
<div id="wrapper">
    <div class="content">
        <h1>Kabit Savaiye <span class="right"><a href="<?= base_url() ?>scriptures/" style="margin-right:10px;">Home</a><a
        ...
        <div class="content_inner">
							 ...
							 if($sess_search_parameters['individual_search'] != 1)
							  {
								...
								$this->load->view('forms/search_results_scripture_combo',array('this_page'=>'ks')); 
							  }
							  ?>
							  <br>
							  <?php 
                        ...
                        <table width="100%" cellspacing="0" cellpadding="2" border="0">
                            ...
                            <tr>
                                <td width="100%" nowrap="nowrap" bgcolor="#fceaaa" align="center"
                                    class="pageheadergreen"> Kabit Savaiye
                                </td>
                            </tr>
                            <tr>
            ...
            if ($search_results === false) {
                ...
                foreach ($search_results->result() as $line) {
                    ...
                    $attributes = '<a href="' . site_url('scriptures/kabit/' . $line->kabit . '/line/' . $line->lineno) . '">
