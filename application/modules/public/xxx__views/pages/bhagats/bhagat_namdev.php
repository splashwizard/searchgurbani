<!--start-->
<br/><h2>Bhagat Namdev Ji </h2>
<hr/>


<blockquote>
    <p class="subhead">&nbsp;&quot;In the imperishable realm of the
        Formless Lord, I play the flute of the unstruck sound current.&quot;</p>
</blockquote>
<p><img src="<?php echo base_url(); ?>/images/content/namdev.jpg" alt="bhagat namdev" width="338" height="270"
        align="left"/>God's
...
<p> Guru Granth Sahib recognizes many saints of the Bhakti movement of medieval
    ...
    is the only voice remained for such saints over the years. </p>
<p> According to the generally accepted version of the current traditions,
    ...
    and kirtan, chanting mostly verses of his own composition.</p>
<p> In the company
    ...
    of the attributeless ( nirguna) Absolute. </p>
<p> Bhagat Nam Dev is a pioneer of the Radical bhakti School. Though he
    ...
    submission (Abhg. 83).<img src="<?php echo base_url(); ?>/images/content/namdev1.jpg" alt="" width="300"
                               height="240" align="right"/></p>
<p> NamDev's cosmogenic views are also orthodox. He says that God created
...
<p> The world being a play of maya and not being a worthwhile of spiritual
...
<p> NamDev not only claims union with God, but, like Kabir, also states
...
<p> Shabad by Bhagat Nam Dev in the Siri Guru Granth Sahib where the temple
    rotated towards his direction as he was not allowed to sit in there.</p>
<blockquote>
    <p class="blue"><em>Laughing and playing, I came to Your Temple, O Lord.<br/>
            ...
            the darshan of the Lord.<br/>
            Nam Dev milked the brown cow,<br/>
            ...
            my mind will be happy.<br/>
            Otherwise, my father will be angry with me. || 1 || Pause ||<br/>
            Taking the golden cup, Nam Dev filled it with the ambrosial milk,<br/>
            and placed it before the Lord. || 2 ||<br/>
            The Lord looked upon Nam Dev and smiled.<br/>
            This one devotee abides within my heart. || 3 ||<br/>
...
<p class="green">Extracted from Gurbani De Racheta by S Abnashi Singh
