...
<div class="content">
    ...
    <p><a href="<?php echo base_url(); ?>gurus/gurunanak"><strong>GURU
                NANAK DEV JI</strong></a></p>
    <p>Born
        in 1469 to a Hindu family near the city of Lahore (now a part of
    ...
    <p>There
        is No Hindu, There is No Muslim</p>
    <p>This
    ...
    <p><a href="<?php echo base_url(); ?>gurus/guruangad"><strong>2.
    ...
    <p><a href="<?php echo base_url(); ?>gurus/guruamar"><strong>3. GURU AMAR DAS </strong></a><br/>
        ...
        his predecessors, he sharply criticized the practice of sati, where widows immolated themselves on the funeral
        pyres of their
    ...
    <p><a href="<?php echo base_url(); ?>gurus/gururamdas"><strong>4.
    ...
    <p><a href="<?php echo base_url(); ?>gurus/guruarjun"><strong>5.
    ...
    <p><a href="<?php echo base_url(); ?>gurus/guruhargobindi"><strong>6.
    ...
    <p><a href="<?php echo base_url(); ?>gurus/guruharrai"><strong>7.
        ...
        Mughal empire.</p>
    <p><a href="<?php echo base_url(); ?>gurus/guruharkrishan"><strong>8.
    ...
    <p><a href="<?php echo base_url(); ?>gurus/guruteghbhadur"><strong>9.
    ...
    <p><a href="<?php echo base_url(); ?>gurus/gurugobind"><strong>10.GURU
                GOBIND SINGH</strong></a></p>
    <p>Upon
        the death of his father, Guru Gobind Singh felt compelled to organize
    ...
    <p> Before
        ...
        from the <a href="<?php echo base_url(); ?>guru-granth-sahib/introduction">Guru Granth Sahib.</a> In essence,
        the light of Nanak, the first Guru, was to be forever
        enshrined within the pages of the <a href="<?php echo base_url(); ?>guru-granth-sahib/introduction">Guru
            Granth Sahib.</a></p>
    <p>To
        illustrate his point that the <a href="<?php echo base_url(); ?>guru-granth-sahib/introduction">Guru Granth
        ...
        pages worth of literature, in the <a href="<?php echo base_url(); ?>gurus/gurugranth">Guru
            Granth Sahib</a><a href="<?php echo base_url(); ?>guru-granth-sahib/introduction">.</a> A separate volume,
