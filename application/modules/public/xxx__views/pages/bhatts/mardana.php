<!--start-->
<br/><h2>Bhai Mardana</h2>
<hr/>
<div class="content">
    <p><img src="<?php echo base_url(); ?>images/content/Mardana.jpg" alt="" width="300" height="233" align="left"/>Mardana
        ...
        and a Mirasi or minstrel by caste and re­beck player by profession.
    ...
    <hr/>
    <p>Bhai Mardana was Guru Nanak's long-time Muslim companion throughout his
        ...
        he sang the hymns . </p>
    <p>As Guru Nanak was employed to take charge of the granaries and stores
    ...
    <p>When Guru Nanak Prepared to go forth into the world to preach his message,
        ...
        on his travels. </p>
    <p>To relieve the rigour of the journeys, the biographies describe several
    ...
    <p>The janam sakhis also contain many anecdotes
    ...
    <p>According to Puratan Janam Sakhi, Mardana and
    ...
    <p>In 1524, at Kartarpur, Mardana, fell ill. He
        ...
        his
        heavenly home. </p>
    <p>Mardana was a poet of some merit. One of his slokas appears in Guru Granth
        ...
        sangat (GC, 553). </p>
    <hr/>
    <p>Bhai Mardana is the most significant character identified in Janam Sakhis
    ...
    <p>&quot;Ek Baba Akal Rup Duja Rababi Mardana&quot;<br/>
    ...
    <p>Due to the lack of historical material, it is difficult to write much
        about Bhai Mardana. Nevertheless, we attempt this presentation with the
        following thoughts.</p>
    <p>Bhai Mardana Ji is the very first entry in Sikh
    ...
    <p>Bhai Mardana Ji and Guru Nanak Dev Ji were childhood friends since they
        lived in the same village.</p>
    <p>Being member of the Marasis Rababi fraternity, Bhai Mardana was an accomplished
    ...
    <p>While it is well established that Bhai Mardana
    ...
    <p>Guru Nanak Dev resigned from his job as storekeeper of a provision store
    ...
    <p>Whenever Bani ascended, the strings of Bhai Mardana's Rabab initiated
        ...
        this world.</p>
    <p>Once Bhai Mardana inquired the reasons behind
    ...
    <p>Guru Sahib had decided to settle at Kartarpur.
    ...
    <p>Bhai Mardana Ji dedicated himself for the heavenly and sacred mission
    ...
    <p>Bhai Mardana was extremely simple, pure, honest and friendly. He was
    ...
    <p>Bhai Mardana had all the worldly qualities and characteristics. For this
        reason he could always seek answers to his doubts and questions from Guru
        Sahib.</p>
    <p>Bhai Mardana was simple natured while Guru Nanak Dev Ji was a master
    ...
    <p>Bhai Mardana Ji was well aware that the person
    ...
    <p>Bhai Mardana, as a result of Guru Nanak Dev Ji's blessing, had acquired
        the ultimate understanding. He understood the mysterious and incomprehensible
        secrets of the universe from Guru Baba.</p>
    <p>Bhai Mardana received yet another unique honor that no subsequent Sikh
        ...
        Bhai Mardana.</p>
    <p>Bhai Mardana's role in Janam Sakhis is one of helper. As a helper, Bhai
    ...
    <p><br/>
        ...
        them like the sun.&quot;</p>
    <p>According to Bhai Khan Singh, Bhai Mardana died on 13th Mugar Sanmat
    ...
    <p>In conclusion, all we can say that Bhai Mardana was a person of utmost
    ...
    <p>Bhai Mardana was the very first kirtania of Sikh history. His Rabab,
