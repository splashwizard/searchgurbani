<!--start-->
<br/><h2>Matra: The beat </h2>
<hr/>
<div class="content">

    <table width="98%" border="0" align="center" cellpadding="2" cellspacing="2">
        <tr>
            <td><p>The matra is the &quot;beat&quot; in Indian music. Along with the vibhag (measure) and the avartan
          ...
          The smallest units the akshara (letter) and its several types are as follows: </span></p>
                ...
                <p>The beats may have a different significance depending on where they come in the cycle. Beats that
                    occur at the beginning of any measure (vibhag) are always more significant then the beats which
                    occur midway in a measure. The first beat of the cycle (avartan) is the most important beat of all.
                    It is called sam.</p>
                <p>Indian music does not flow in metronome time; therefore the value of the beats may be stretched or
                    contracted depending on numerous factors. This is easily demonstrated, but surprisingly enough is
                    not acknowledged in traditional theory. One must understand the music thoroughly to know when such
