...
<h3>
    Glory of Sri Dasam Granth Sahib </h3>
<div>
    <p>Created with the aim of waging a war of righteousness the Dasam Granth is that unique and unforgettable offering
        ...
        only.</p>
    <p>In that terrible darkness, the tenth Guru, Sri Guru Gobind Singh Ji was born at Patna in 1666 AD as the
        ...
        exist.</p>
    <p>Sri Guru Nanak Dev Ji had refuted and refused to accept all adynamic, parochial, and inhuman religious practices.
    ...
    <p>Finally, Sri Guru Gobind Singh Ji gave manifestation to his goal for the well being of all humanity in the form
    ...
    <p>Guru Gobind Singh Ji was a magnanimous soul. His vision, creation (the Khalsa) and his literary writing all have
    ...
    <p>With a view to create a society free from exploitation and tyranny, he spelt out his aim - "Dharam yudh ko chao"
...
<div>
    <p>The complete literary works of Guru Gobind Singh Ji are compiled in the Dasam Granth. These were put together in
...
<div>
    <p class="subhead"><a href="<?php echo base_url(); ?>dasam-granth/page/1">JAAP SAHIB</a></p>
</div>
<div>
    <p>Jaap Sahib, given place of prominence in the Dasam Granth is the invocation made by the khalsa-a hymn in praise
    ...
    <p>In fact, of all the transcendental literature written in the middle age the Jaap Sahib stands out unique for
    ...
    <p>The Jaap Sahib has evolved as the product of extensive reflection, cogitation and deliberation through moments of
    ...
    <p>From the point of view of diction and style too it is a matchless piece of writing. The vocabulary used and the
    ...
    <p>Another outstanding feature of the Jaap Sahib is the beautiful and amazing manner in which worship and might
...
<div>
    <p class="subhead"><a href="<?php echo base_url(); ?>dasam-granth/page/33">AKAAL USTAT</a></p>
</div>
<div>
    <p>The second piece of writing included in the Dasam Granth is called the Akaal Ustat. Herein a major myth has been
    ...
    <p>In this literary work the various forms of God as perceived by man are described and the spiritual, the
        philosophical and the social beliefs have been clearly elucidated.</p>
    <p>In the Akaal Ustat, the Almighty God has been described in all his glory by making use of metaphysical references
    ...
    <p>At various points, in this composition Guru ji has spoken out against the caste system. Perhaps no other writer
    ...
    <p>On the whole, the picture of God that emerges through the Akaal Ustat is complete-He is the Perfect, Ommipotent,
...
<div>
    <p class="subhead"><a href="<?php echo base_url(); ?>dasam-granth/page/94">BACHITTAR NATAK</a></p>
</div>
<div>
    <p>The third creation to be compiled in the Dasam Granth is the Bachittar Natak. As evident from the editorial notes
    ...
    <p>As per the requirements of the times and the society, God is portrayed not only as benevolent, loving and
    ...
    <p>Although the writing is entitled Bachittar Natak it is not by any stretch of imagination a drama since it doesn&acirc;t
...
<div>
    <p class="subhead"><a href="<?php echo base_url(); ?>dasam-granth/page/175">CHANDI CHARITRA</a></p>
</div>
<div>
    <p>The Chandi Charitra follows and in fact is a part of the Bachittar Natak. The aim of writing this piece was to
...
<div>
    <p>This composition is in the form sawaiye-an Indian metre of one and a quarter line. The mood is essentially
    ...
    <p>The third piece of writing associated with the portrayal of Chandi is called Chandi di Vaar. Written in
...
<div>
    <p>Following the invocation, this composition highlights the major events and incidents about Chandi as mentioned in
    ...
    <p>The main reason for writing about Chandi so many times was that Guru Gobind Singh Ji wanted to affect a sea
...
<div>
    <p class="subhead"><a href="<?php echo base_url(); ?>dasam-granth/page/325">GYAN PRABODH</a></p>
</div>
<div>
    <p>This composition has two main divisions. The first part is devoted to the praise of the Almighty God, He who is
    ...
    <p>The second part is in the form of a dialogue in which the soul questions God about that super power whose
    ...
    <p>Then the soul asks about the four dharmas in answer the four dharmas are elaborated upon. These are Raj dharma,
...
<div>
    <p class="subhead"><a href="<?php echo base_url(); ?>dasam-granth/page/643">CHOUBEES AVATAR</a></p>
</div>
<div>
    <p>This is a very important literary piece. In this the stories of twenty-three Avatars of lord Vishnu have been
    ...
    <p>At the beginning, Guru Gobind Singh Ji has clearly stated his aim for writing this literary piece. In this God
...
<div>
    <p class="subhead">UP AVATAR</p>
</div>
<div>
    <p>This composition follows Chaubees Avatar. It begins by narrating the incidents and experiences of Brahma. But in
    ...
    <p>There are no such references in any of the existing scriptures. This composition is the outcome of Guru Gobind
        Singh Ji&acirc;s imagination.</p>
    <p>The references to Brahma are followed by two avatars of Rudra-Dattatreya and Parasnath. Rudra too fell prey to
        conceit and suffered for it like Brahma. Similarly he had to take on the form of two avatars to redeem his
        mistake.</p>
    <p>On reading these episodes on finds that the various avatars can be categorized under three heads. Shastradhari or
...
<div>
    <p class="subhead">PHUTKAL RACHNAWAN<br/>
        (OTHER COMPOSITIONS)</p>
</div>
<div>
    <p>There are three compositions that feature herein-Shabad Hazaarey, Sawaiye and Khalsa Mahima.</p>
    <p>1) <a href="<?php echo base_url(); ?>dasam-granth/page/1343">SHABAD HAZAAREY</a></p>
    <p>These are composed in nine different ragas and are in the style of the Bishanpadas. In these Guru Ji has given
    ...
    <p>These are thirty-three in all. Apart from describing the form of the Khalsa, these describe God in a style very
    ...
    <p>This has four verses. It delineates the glory that is associated with the Khalsa. Guru Ji explains the role of
...
<div>
    <p class="subhead"><a href="<?php echo base_url(); ?>dasam-granth/page/1356">SHASTRA NAAM MALA</a></p>
</div>
<div>
    <p>More in the form of a dictionary in verse, this composition includes the description of the various weapons used
...
<div>
    <p class="subhead">CHARITROPAKHIYAN</p>
</div>
<div>
    <p>This composition highlights the various faces of woman. While the positive roles played by woman as a wife, as a
        mother, as a soldier are outlined, the negative aspect of some women who stoop to lowly activities has also been
        brought out.</p>
    <p>It begins by elucidating the extreme bravery and courage of Devi Bhagwati and highlights her various deeds of
    ...
    <p>Thus, through the given examples, Guru Ji has formulated a very strong value system for the reader, laying down
        rules to be upheld and followed by both men and women so that a society free from all mortal sins may be
        formed.</p>
</div>
<div>
    <p class="subhead"><a href="<?php echo base_url(); ?>dasam-granth/page/1469">ZAFARNAMA</a></p>
</div>
<div>
    <p>This is a historic document sent by guru Gobind Singh Ji to Aurangzeb. It was written in the year 1706 AD while
    ...
    <p>The extreme courage that has been displayed by the Guru in addressing the emperor and rebuking him for the wrongs
...
<div>
    <p class="subhead">HIDAYATAN</p>
</div>
<div>
    <p>There are eleven hidayatan or pieces of advice included in the Dasam Granth. These are written in Persian and in
    ...
    <p>Thus it is clear that the compositions in the Dasam Granth were created with the sole aim of promoting truth. It
